...
class NoteViewModel @Inject constructor(
    ...
    * */
    ...
    private val _notesState = MutableStateFlow<List<Note>?>(null)
...
//                notes.map { it.copy(origin = REMOTE, isSync = true) }
//                noteRepository.addNoteLocal(notes)
//            }
        }
    }
